...
<html>
    ...
    <body>
        ...
        <div class="jumbotron">
            <div class="container">
                <h1>Perfil Motorista</h1>               
            </div>           
        </div>

        <div class="container">
            <form class="form-horizontal" data-toggle="validator" action="${pageContext.request.contextPath}/motorista_cadastrar" method="post">

                <div class="form-group">
                    <label for="nome_completo" class="col-sm-2 control-label">Nome Completo*</label>
                    <div class="col-sm-10">
                        <input type="text" name="nome_completo" class="form-control" id="nome_completo" placeholder="Nome Completo" data-error="Preencha este campo." required autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="modelo_carro" class="form-control" id="modelo_carro" placeholder="Toyota Corolla" data-error="Preencha este campo." required>
                        <div class="help-block with-errors"></div>
                    </div>
